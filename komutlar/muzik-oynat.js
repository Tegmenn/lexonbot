...
exports.run = async (client, message, args) => {
    ...
    async function handleVideo(video, message, voiceChannel, playlist = false) {
        ...
        .setColor("GREEN")
        .setAuthor(`Şimdi oynatılıyor:`)
        .setDescription(`[${song.title}](${song.url})`)
        .addField("**Süre:**", `${y}`, true)
        .addField("**Oynatan:**", `${song.requester}`, true)
        .setImage("https://images-ext-2.discordapp.net/external/b_nOTMyYBlkc73HwIzyDIH1VbpD4FVMSxixBLJP0mnc/%3Fwidth%3D400%26height%3D222/https/media.discordapp.net/attachments/735246740520697996/736194830467727360/53.gif?width=320&height=178")
